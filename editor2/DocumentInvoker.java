...
public class DocumentInvoker {
    ...
    public void Italic(int line) {
        DocumentItalicCommand cmd = new DocumentItalicCommand(currentdoc, line);
        commands.add(cmd);
    }

    public void RemoveItalic(int line) {
        DocumentRemoveItalicCommand cmd = new DocumentRemoveItalicCommand(currentdoc, line);
        commands.add(cmd);
    }

    public void Insert(int line, String text) {
        DocumentInsertCommand cmd = new DocumentInsertCommand(currentdoc, line, text);
        commands.add(cmd);
    }
