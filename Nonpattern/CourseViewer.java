...
public class CourseViewer extends JFrame implements ActionListener,
    ...
    public void paint(Graphics g) {
        ...
        //extend
        int radius = 100;
        int centerX = LayoutConstants.xOffset - 50 + radius;
        int centerY = LayoutConstants.yOffset + 300 + radius;
        double total = 0.0;

        for (JSlider record : sliders) {
        ...
        for (int i = 0; i < sliders.size(); i++) {
            ...
            g.fillArc(LayoutConstants.xOffset - 50, LayoutConstants.yOffset + 300,
                    2 * radius, 2 * radius,
